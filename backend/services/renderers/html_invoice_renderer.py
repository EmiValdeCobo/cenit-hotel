# backend/services/renderers/html_invoice_renderer.py
"""
Renderizador HTML Concreto para Facturas (Patrón Strategy / Template).
Genera una plantilla HTML responsive con diseño luxury para impresión y vista previa.
"""
from typing import Dict, Any
from services.renderers.base_renderer import BaseInvoiceRenderer

class HTMLInvoiceRenderer(BaseInvoiceRenderer):
    """Estrategia concreta de renderizado de facturas en formato HTML visual de alta fidelidad."""

    def render(self, factura: Dict[str, Any]) -> str:
